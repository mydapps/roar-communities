...
import { Loader2, Plus, Minus, Info, ArrowRight } from 'lucide-react';
...
export const TradeDialog = ({ 
  ...
  const handleShareQuantityChange = (value: number) => {
    ...
    const newQuantity = Math.min(Math.max(value, 0.01), maxShares);
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                <Button
                  ...
                  disabled={shareQuantity <= 1 || loading || loadingAction}
