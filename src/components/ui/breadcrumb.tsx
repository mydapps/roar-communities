...
>(({ className, ...props }, ref) => (
  <ol
    ref={ref}
    className={cn(
      "flex items-center gap-1.5 break-words text-sm text-muted-foreground sm:gap-2.5 overflow-hidden",
      className
    )}
    {...props}
  />
...
>(({ asChild, className, ...props }, ref) => {
  ...
  return (
    <Comp
      ref={ref}
      className={cn("transition-colors hover:text-foreground truncate", className)}
      {...props}
    />
  )
})
