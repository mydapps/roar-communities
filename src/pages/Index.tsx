...
const Index = () => {
  ...
  useEffect(() => {
    ...
    console.log('Device loading status:', isLoading);
    console.log('Is mobile app?', isMobileApp);
    
    if (!isLoading) {
      if (isMobileApp) {
        console.log('User is on native mobile app:', deviceInfo);
        console.log('Platform:', isAndroidApp ? 'Android' : isIOSApp ? 'iOS' : 'Unknown');
      } else {
        console.log('User is on web app');
      }
    }
  }, [isLoading, isMobileApp, isAndroidApp, isIOSApp, deviceInfo, location.pathname]);
  ...
  const renderMobilePage = () => {
    console.log('Rendering mobile app landing page');
    return (
      <>
        <Helmet>
  ...
  const renderWebPage = () => {
    console.log('Rendering web landing page');
    return (
  ...
  // First, check if we're still loading device info
  if (isLoading) {
    console.log('Device info still loading, showing temporary loading state');
    return <div className="flex items-center justify-center h-screen">Loading...</div>;
  }

  // Then check if we're on a mobile app and render appropriate page
  if (isMobileApp) {
